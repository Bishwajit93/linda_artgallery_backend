...
class Image(models.Model):
    ...
    uploaded_at = models.DateTimeField(auto_now_add=True)         # keep if you like it
    created_at = models.DateTimeField(auto_now_add=True)          # add this
    order = models.PositiveSmallIntegerField(default=0)           # add this
    is_published = models.BooleanField(default=False)
    

    class Meta:
        ordering = ["order", "-created_at"]                      # match your views
